module NotificationsHelper
  ...
  def notification_form(notification)
	  ...
	  case notification.action
	    when 'favorite' then
	      tag.a(@visiter.name, href:public_user_path(@visiter), style:'font-weight: bold;', class: 'text-dark')+'が'+tag.a('あなたのコメント',href:public_post_path(notification.comment.post), style:'font-weight: bold;')+'にいいねしました'
	    when 'comment' then
